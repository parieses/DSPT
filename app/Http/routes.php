...
Route::post('/changpwd','Home\InformationController@changpwd');

//修改个人信息
Route::post('/new_User','Home\InformationController@new_User');


Route::get('/information','Home\InformationController@information');

//收获地址
Route::post('/address','Home\InformationController@address');