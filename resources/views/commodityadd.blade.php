<!DOCTYPE html>
<!-- saved from url=(0089)http://demodaojia.ecjia.com/sites/merchant/index.php?m=goods&c=merchant&a=add&cat_id=1032 -->
    ...
    <div class="container">
        <div id="main" class="main_content" style="opacity: 1;">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="http://demodaojia.ecjia.com/sites/merchant/index.php?m=goods&amp;c=merchant&amp;a=init">商品列表</a></li>
            ...
            <div class="page-header">
                ...
                <div class="pull-right">
                    <a href="http://demodaojia.ecjia.com/sites/merchant/index.php?m=goods&amp;c=merchant&amp;a=init" class="btn btn-primary data-pjax">
                        <i class="fa fa-reply"></i> 商品列表
                    </a>
                </div>
                                ...
                                <form class="form-horizontal" enctype="multipart/form-data"  method="post" name="theForm" action="/Admin/commoditylistsave ">
                                    ...
                                    <div class="col-lg-7 pull-left">
                                        <div class="form-group m_t10">
                                            ...
                                            <div class="controls col-lg-7">
                                                <input class="form-control" name="商品名称" type="text" value="" style="color:;">
                                            </div>
                                            <span class="input-must"><span class="require-field" style="color:#FF0000,">*</span></span>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2"  style="margin-right: 15px;">分类：</label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-2">作为商品：</label>
                                            <div class="col-lg-10">
                                                <div class="checkbox">
                                                    <input id="is_alone_sale" type="checkbox" name="作为商品" value="1" checked="">
                                                    <label for="is_alone_sale">打勾表示能作为普通商品销售，否则只能作为配件或赠品销售。</label>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-lg-2">是否包邮：</label>
                                            <div class="col-lg-10">
                                                <div class="checkbox">
                                                    <input id="is_shipping" type="checkbox" name="是否包邮" value="1">
                                                    <label for="is_shipping">打勾表示此商品不会产生运费花销，否则按照正常运费计算。</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-group">
                                            <div class="panel panel-info">
                                                <div class="panel-heading">
                                                    <a data-toggle="collapse" data-parent="#accordionTwo" href="http://demodaojia.ecjia.com/sites/merchant/index.php?m=goods&amp;c=merchant&amp;a=add&amp;cat_id=1032#collapseTwo" class="accordion-toggle">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group m_b0">
                                                            ...
                                                            <div class="col-lg-9 p_l0">
                                                                <textarea class="form-control" name="商家备注" cols="40" rows="3"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-5 pull-right">
                                        <div class="panel-group">
                                            <div class="panel panel-info">
                                                <div class="panel-heading">
                                                    <a data-toggle="collapse" data-parent="#accordionTwo" href="" class="accordion-toggle">
                                                        <span class="glyphicon"></span>
                                                ...
                                                <div id="collapseThree" class="panel-collapse collapse in">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="checkbox">
                                                                <input id="is_on_sale" type="checkbox" name="上架" value="1" checked="">
                                                                <label for="is_on_sale">打勾表示允许销售，否则不允许销售。</label>
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label col-lg-3">加入推荐：</label>
                                                            <div class="col-lg-9 p_l0">
                                                                <div class="checkbox">
                                                                    <input id="is_best" type="checkbox" name="精品" value="1">
                                                                    <label for="is_best">精品</label>

                                                                    <input id="is_new" type="checkbox" name="新品" value="1">
                                                                    <label for="is_new">新品</label>

                                                                    <input id="is_hot" type="checkbox" name="热销" value="1">
                                                        ...
                                                        <div class="form-group m_b0">
                                                                <button class="btn btn-info complete m_l5" type="submit" id="btn">直接完成</button>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="accordion-body in collapse" id="goods_info_area_img">
                                                                <div class="accordion-inner">
                                                                    <div class="control-group">
                                                                        <div class="ecjiaf-db">
                                                                            <div class="goods_img">
																	<span class="btn fileupload-btn">
																		<span class="fileupload-exists">

    <input class="glyphicon glyphicon-plus" style="width: 33px;margin-left: 20px;" type="file" name="图片" ID="fupPhoto"/>
                                                                        </span>
                                                                        {{ csrf_field() }}
																	</span>
                                                                            ...
                                                                            {{--</div>--}}
                                                                            {{--<button class="btn btn-info complete m_l5" type="submit" id="btn">直接完成</button>--}}
                                                                            <div class="thumb_img hide">
                                                                                <label class="ecjiaf-db">商品缩略图：</label>
                                                                                <span class="btn fileupload-btn">
																		<span class="fileupload-exists">
