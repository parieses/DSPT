<!DOCTYPE html>
<!-- saved from url=(0085)http://demodaojia.ecjia.com/sites/merchant/index.php?m=adsense&c=mh_cycleimage&a=init -->
...
@include('public.js')
    ...
    <link rel="stylesheet" id="bootstrap-fileupload-css" href="/static/bootstrap-fileupload.css" type="text/css" media="">
    <link rel="stylesheet" id="merchant-css" href="http://demodaojia.ecjia.com/content/apps/adsense/statics/styles/merchant.css?ver=1.24" type="text/css" media="all">
    ...
    <script type="text/javascript" src="http://demodaojia.ecjia.com/content/apps/adsense/statics/js/mh_cycleimage.js?ver=1.24"></script>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <div class="form">
                                    ...
                                    <form class="form-horizontal" name="theForm" action="/Admin/carouselfigure" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-6">
													...
													<input type="file" name="ad_code" class="default">
                                                        ...
                                                        <a class="btn btn-danger btn-sm fileupload-exists" data-dismiss="fileupload" href="http://demodaojia.ecjia.com/sites/merchant/index.php?m=merchant&amp;c=merchant&amp;a=drop_file&amp;code=ad_code">删除</a>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls col-lg-6">
                                                    <input id="open" name="enabled" value="1" type="radio" checked="true">
                                                    <label for="open">开启</label>
                                                    <input id="close" name="enabled" value="0" type="radio">
...
<a href="http://demodaojia.ecjia.com/sites/merchant/index.php?m=adsense&amp;c=mh_cycleimage&amp;a=init#" id="toTop" style="display: none;"><span id="toTopHover"></span>To Top</a></body></html>